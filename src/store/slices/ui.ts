...
const uiSlice = createSlice({
  ...
  reducers: {
    ...
    openExpandedPlayer(state) {
      state.expandedPlayerOpen = true;
    },
    closeExpandedPlayer(state) {
      state.expandedPlayerOpen = false;
    },
    toggleExpandedPlayer(state) {
      state.expandedPlayerOpen = !state.expandedPlayerOpen;
    },
  },
});
